        ...
        <div>
            <table class="auto-style1">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tb_fname" onkeyup="javascript:fnamevalidate()" runat="server"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tb_ccn" onkeyup="javascript:cardvalidate()" runat="server"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tb_exp" onkeyup="javascript:expvalidate()" runat="server"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tb_cvv" onkeyup="javascript:cvvvalidate()" runat="server"></asp:TextBox>
                        <asp:Label ID="cvv" runat="server" Text="&nbsp;"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div class="g-recaptcha" data-sitekey="6LcZYEQeAAAAAPpO9jzY9JwOTu-64rT3NAAzAFWi"></div>
                    </td>
                </tr>
                <tr>
